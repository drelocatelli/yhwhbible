        ...
        if(book.selected == true) {
            ...
            fetch(request).then(function(response) { return response.text() }).then(function(response){
                ...
                verses.forEach(function(verse){
                    ...
                    verse['text'] = verse['text'].replaceAll(/Deus|deus /gim, 'Yauh (יהוה)').replaceAll(/Senhor|senhor/gim, 'criador').replaceAll(' puro ',' limpo ').replaceAll(' misericórdia ', ' compaixão ').replaceAll(',]', ']').replaceAll('"','ˮ').replaceAll(' cruz ',' madeiro ').replaceAll(' Cruz ', ' madeiro ').replaceAll(/amém/gim, ' assim seja ').replaceAll(' batismo ', ' imersão ').replaceAll(' vitória ',' conquista ').replaceAll(' misericordioso ',' benevolente ').replaceAll('.','. ').replaceAll('!','! ').replaceAll(' Amém ',' Assim seja ').replaceAll('?', '? ').replaceAll(' pausa ','  ').replaceAll(' Pausa ', '  ').replaceAll('broquel', 'couraça').replaceAll(' todo-poderoso ',' onipotente ').replaceAll(' Todo-poderoso ',' onipotente ').replaceAll(' Todo-Poderoso ',' onipotente ').replaceAll('laço do passarinho', 'laço do caçador').replaceAll(' Judá ',' Yaudah ').replaceAll(' judá ', ' yaudah ').replaceAll(' David ',' Davi ').replaceAll(/Jesus|Jesus /gim,' Yausha (יהושע) ').replaceAll(' JESUS ',' YAUSHA (יהושע) ').replaceAll(' Jesus Cristo ',' Yausha (יהושע) ').replaceAll(' Cristo ',' Yausha (יהושע) ').replaceAll(/Cristo|Cristo /gim,'Yausha (יהושע)').replaceAll(' EMANUEL ',' YAUSHA (יהושע) ').replaceAll(' mui ',' muito ').replaceAll(' muitoto ',' muito ').replaceAll(' muimuito ',' muito ').replaceAll(/(\bgraça\b|\bgraças\b)/ig, ' benevolência ').replaceAll(' batismo ',' imersão ').replaceAll(/(\bglória\b|\bglórias\b)/ig,' grandeza ').replaceAll(/vitória/ig,' conquista ').replaceAll(' justiça ',' honra ').replaceAll(/libertação/ig,' salvação ').replaceAll(/luz/ig,' claridade ').replaceAll(/^dia| dia | dia|dia $/gim, 'tempo').replaceAll(/noite/gim,' fim de tarde ').replaceAll(/pai eterno/gim,'YAUH (יהוה)').replaceAll(' ç rei ', 'YAUH (יהוה)').replaceAll(/israel/gim,'Yaushalaim (Israel)').replaceAll(' muitotas ',' muitas ').replaceAll(' áspide ',' víbora ').replaceAll(' da fim de tarde ',' do fim de tarde ').replaceAll(' a seta que voe detempo',' a seta que voe de dia ').replace(', e da peste perniciosa','  que se ocupa em destruir ').replaceAll('Yausha (יהושע) Yausha (יהושע)', 'Yausha (יהושע)')
